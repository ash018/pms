<?php
    ...
    $presRows = getAllFollowupsAccordingtoCurrentUser($userId);
    
?>

<html>
<?php echo attachedHeader('Followup'); ?>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2><center>All Follow Up Prescription</center>
                            </h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover specialCollapse">
                                            ...
                                            <tbody>
                                                ...
                                                <td><?php echo $row['nextvisitingdate']; ?></td>

                                                <td><a data-toggle="tooltip" data-placement="top"  data-original-title="Edit Followup" class="btn btn-info" href="<?php echo '../../views/public/edit_prescription.php?id='.$row['id'].'&patientId='.$row['patientId']; ?>">
