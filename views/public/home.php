...
<head>
    ...
    <!-- Morris Chart Css-->
    <link href="../../assets/BSBTheme/plugins/morrisjs/morris.css" rel="stylesheet" />
...
<!-- Jquery Core Js -->
    ...
    <script src="../../assets/BSBTheme/plugins/jquery-countto/jquery.countTo.js"></script>

    <!-- Morris Plugin Js -->
    <script src="../../assets/BSBTheme/plugins/raphael/raphael.min.js"></script>
    <script src="../../assets/BSBTheme/plugins/morrisjs/morris.js"></script>

    <!-- ChartJs -->
    <script src="../../assets/BSBTheme/plugins/chartjs/Chart.bundle.js"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="../../assets/BSBTheme/plugins/flot-charts/jquery.flot.js"></script>
    <script src="../../assets/BSBTheme/plugins/flot-charts/jquery.flot.resize.js"></script>
    <script src="../../assets/BSBTheme/plugins/flot-charts/jquery.flot.pie.js"></script>
    <script src="../../assets/BSBTheme/plugins/flot-charts/jquery.flot.categories.js"></script>
    <script src="../../assets/BSBTheme/plugins/flot-charts/jquery.flot.time.js"></script>

    <!-- Sparkline Chart Plugin Js -->
    <script src="../../assets/BSBTheme/plugins/jquery-sparkline/jquery.sparkline.js"></script>

    <!-- Custom Js -->
    <script src="../../assets/BSBTheme/js/admin.js"></script>
    <script src="../../assets/BSBTheme/js/pages/index.js"></script>
